                    ...
                    <div style={{ width: '100%', height: 400 }}>
                        <ResponsiveContainer>
                            <AreaChart data={data}
                                ...
                                <CartesianGrid strokeDasharray="3 3" />
                                <Tooltip />
                                <Area type="monotone" stackId="1" dataKey="investment" stroke="#8884d8" fillOpacity={1} fill="url(#colorInv)" />
                                <Area type="monotone" stackId="1" dataKey='revenue' stroke="#82ca9d" fillOpacity={1} fill="url(#colorRev)" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </div>
