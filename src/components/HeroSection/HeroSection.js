...
const HeroSection = () => {
    return (
        <div className='heroSection'>
            <div className='w-11/12 mx-auto grid grid-cols-1 gap-4 md:grid-cols-3 items-center md:min-h-screen'>
                <div className='col-span-1 order-2 md:col-span-2 md:order-1'>
                    <div className='my-10 md:my-20 pl-6'>
                        <h1 className='text-5xl md:text-8xl text-slate-800'>Your perfect partner!</h1>
